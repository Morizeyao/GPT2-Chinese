...
def main():
    ...
    parser.add_argument(
        "--temperature", default=1, type=float, required=False, help="生成温度，越高越随机"
    )
    parser.add_argument(
        "--topk", default=8, type=int, required=False, help="生成的时候最高几选一"
    )
    parser.add_argument(
        "--topp", default=0, type=float, required=False, help="生成的时候积累概率最高多少"
    )
    parser.add_argument(
        "--model_config",
    ...
    parser.add_argument(
        "--save_path", default="generated/", type=str, required=False, help="存放生成的文件的路径"
    )
    parser.add_argument(
        "--articles_per_title", default=5, type=int, required=False, help="每个标题生成多少篇文章"
    )
    parser.add_argument(
        "--titles", default="萧炎", type=str, required=False, help="标题列表，是一个字符串，用空格分开"
    )
    parser.add_argument(
        "--titles_file",
        default="",
