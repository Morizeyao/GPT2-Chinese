...
- 中文的GPT2训练代码，使用BERT的Tokenizer或GPT2自带的BPE Tokenizer（感谢[fengzuo97](https://github.com/fengzuo97)的支持)或Sentencepiece的BPE model（感谢[kangzhonghua](https://github.com/kangzhonghua)的贡献）。可以写诗，新闻，小说，或是训练通用语言模型。支持字为单位或是分词模式或是BPE模式。支持大语料训练。
