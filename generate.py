...
def main():
    ...
    parser.add_argument('--prefix', default='我', type=str, required=False, help='生成文章的开头')
    ...
    state_dict = {key[6:] :value for key, value in torch.load(args.model_path, map_location='cpu')['state_dict'].items()}
    ...
    for i in range(10):
        ...
        out = sample_sequence(model, encoded, length=512, n_ctx=1024, tokenizer=tokenizer, temperature=temperature, top_k=topk, top_p=topp,
